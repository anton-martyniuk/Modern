...
/// <summary>
/// The <see cref="IQueryProvider"/> implementation for MySql database
/// </summary>
public class MySqlQueryProvider : IQueryProvider
{
        ...
        where TEntity : class
    {
        ...
        queryBuilder.AppendFormat("SELECT {0} FROM {1} where {2} = last_insert_id();", columnsQuery, entityMapping.TableName, entityMapping.IdColumnName);
