...
public class ModernLiteDbAsyncRepositoryGenerator : ISourceGenerator
{
    ...
    private const string EntityTypeMemberName = nameof(ModernLiteDbAsyncRepositoryAttribute.EntityType);
    private const string IdTypeMemberName = nameof(ModernLiteDbAsyncRepositoryAttribute.IdType);
