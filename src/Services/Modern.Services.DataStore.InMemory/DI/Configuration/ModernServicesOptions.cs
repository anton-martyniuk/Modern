...
using ModernServiceConcreteSpecification = Modern.Services.DataStore.InMemory.DI.Configuration.ModernServiceConcreteSpecification;
using ModernServiceSpecification = Modern.Services.DataStore.InMemory.DI.Configuration.ModernServiceSpecification;
