...
using Modern.Controllers.DataStore.OData;
...
public static class ServicesExtensions
{
    ...
    public static ModernServicesBuilder AddODataControllers(this ModernServicesBuilder builder, Action<ModernControllersOptions> configure)
    {
        ...
        {
            var implementationType = typeof(ModernODataController<,,>).MakeGenericType(c.EntityDtoType, c.EntityDboType, c.EntityIdType);
